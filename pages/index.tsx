            ...
            <div
                ...
                <div
                    ...
                    <p className={styles["info-description"]}>
                        This simulation replicates a Powerball power dip scenario. A set of 10 lines with random numbers
                        will be generated, and can be re-generated by pressing on the &quot;Run Simulation&quot; button below. The simulation will generate the random winning numbers
                        and calculate the total winnings according to the divisions. The divisions are listed in the section below.
                        <br />
                        <br />

                        Total Winnings: ${totalWinnings}
                        <br />
                        Winning Numbers: {winningLine.map((number: number): string => number.toString().padStart(2, "0")).join(", ")}
                    </p>
                                                ...
                                                <div className={styles["ticket-col"]} key={j}>
                                                    {j === 0 ?
                                                        <div style={{
                                                            ...
                                                            <span style={{
                                                                color: finalLottoNumbers[i][j].correct ? "red" : "black",
                                                                fontWeight: finalLottoNumbers[i][j].correct ? "bold" : "normal"
                                                            }}>{col.toString().padStart(2, "0")}</span>
                                                        </div> :
                                                        j === 6 ?
                                                            <>
                                                                <span style={{
